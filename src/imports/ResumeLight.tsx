import svgPaths from "./svg-u4645vn7jx";
...
function Text2() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[2px] grow items-start min-h-px min-w-px relative shrink-0" data-name="Text">
      ...
      <a className="block font-['DM_Sans:Medium',sans-serif] font-medium leading-[0] relative shrink-0 text-[#47516b] text-[0px] w-full" href="https://aldesign.it" style={{ fontVariationSettings: "'opsz' 14" }}>
  ...
  return (
    <div className="overflow-clip relative rounded-[5px] shadow-[0px_2px_6px_0px_rgba(0,0,0,0.05)] shrink-0 size-[20px]" data-name="Logo icon">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
        <path d={svgPaths.p20a60600} fill="var(--fill-0, white)" id="Vector" />
      </svg>
  ...
  return (
    <div className="basis-0 bg-[#f7f9fc] grow h-[40.667px] min-h-px min-w-px relative rounded-bl-[4px] shrink-0" data-name="Card">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[2px] h-[40.667px] items-center justify-center px-[2px] py-[8px] relative w-full">
...
function Card6() {
  return (
    <div className="bg-[#f7f9fc] box-border content-stretch flex flex-col gap-[8px] items-center justify-center pl-0 pr-[8px] py-[8px] relative rounded-br-[4px] self-stretch shrink-0 w-[59.333px]" data-name="Card">
      <div className="basis-0 flex flex-col font-['DM_Sans:Medium','Noto_Sans_SC:Medium','Noto_Sans_JP:Medium',sans-serif] font-medium grow justify-center leading-[0] min-h-px min-w-px relative shrink-0 text-[#516cf7] text-[7px] text-center w-[51.333px]" style={{ fontVariationSettings: "'opsz' 14" }}>
        <p className="leading-[9px]">Information Architecture — 信息结构、内容组织</p>
      </div>
    </div>
  );
}
...
function Section() {
  return (
    <div className="basis-0 content-stretch flex flex-col gap-[4px] grow items-center min-h-px min-w-px relative self-stretch shrink-0" data-name="Section">
      <Header4 />
      <Row4 />
      <Card4 />
      <Row5 />
...
function SkillsSection() {
  return (
    <div className="box-border content-stretch flex flex-col gap-[16px] h-[202px] items-start pb-[24px] pt-0 px-0 relative shrink-0 w-[356px]" data-name="Skills section">
...
function Skills() {
  return (
    <div className="content-stretch flex gap-[16px] items-start justify-center relative shrink-0 w-[386px]" data-name="Skills">
      <StepIconWrap2 />
      <SkillsSection />
    </div>
  );
...
function Skills1() {
  return (
    <div className="content-stretch flex gap-[16px] items-start justify-center relative shrink-0 w-[380px]" data-name="Skills">
      <StepIconWrap3 />
      <SkillsSection1 />
    </div>
  );
...
export default function ResumeLight() {
  return (
    <div className="bg-white content-stretch flex items-start relative size-full" data-name="Resume light">
      <Aside />
      <Container2 />
    </div>
  );
